    ...
    <div className="flex-1 p-8 overflow-y-auto">
      ...
      <div className="flex items-center justify-center">
        <div className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full bg-gray-950/5 p-0.75 text-gray-950 dark:bg-white/10 dark:text-white">
          <div className="relative rounded-full p-2 has-checked:bg-white has-checked:ring has-checked:inset-ring has-checked:ring-gray-950/10 has-checked:inset-ring-white/10 sm:p-2 dark:has-checked:bg-gray-600 dark:has-checked:text-white dark:has-checked:ring-transparent flex items-center justify-center flex-col">
            <input
              type="radio"
            ...
            />
            <svg viewBox="0 0 28 28" fill="none" className="size-8">
              <path
